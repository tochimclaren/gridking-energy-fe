...
export const GeneralSettingsTab: React.FC<GeneralSettingsTabProps> = ({
  ...
  const isQuoteNotificationLoading = actionLoading === 'updateQuoteNotifications';
  const isMaintenanceModeLoading = actionLoading === 'updateMaintenanceMode';
  const isProductsPerPageLoading = actionLoading === 'updateProductsPerPage';
        ...
        <div className="p-6">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              disabled={isQuoteNotificationLoading}
              className={`relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed ${
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              disabled={isMaintenanceModeLoading}
              className={`relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed ${
          ...
          <div>
            ...
            <div className="mt-1 relative rounded-md shadow-sm max-w-xs">
              <input
                ...
                disabled={isProductsPerPageLoading}
                className="block w-full pl-3 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              />
              <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                {isProductsPerPageLoading ? (
